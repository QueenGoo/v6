...
Isadmin=$(curl -sS https://raw.githubusercontent.com/QueenGoo/v6/main/ip | grep $MYIP | awk '{print $5}')
...
Exp=$(curl -sS https://raw.githubusercontent.com/QueenGoo/v6/main/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "└──────────────────────────────────────────┘" | lolcat
echo -e "\033[1;96m  Owner        : QUEEN STORE\e[0m"
echo -e "\033[1;96m  Contact WA   : 6283857026355 \e[0m"
echo -e "\033[1;96m  Telegram     : t.me/Queen_Storeb \e[0m"
